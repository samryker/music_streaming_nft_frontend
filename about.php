			...
			<div class="row row--grid">
				...
				<div class="col-12 col-lg-4">
					<div class="step">
						...
						<h3 class="step__title">Enjoy Tailured music</h3>
				...
				<div class="col-12">
					<a href="signup" class="main__load">Sign up</a>
				</div>
			</div>
			...
			<div class="row row--grid">
				...
				<div class="col-12 col-md-6 col-lg-4 order-md-2 order-lg-1">
					<div class="plan plan--green">
						...
						<ul class="plan__list">
							<li class="green"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.71,7.21a1,1,0,0,0-1.42,0L9.84,14.67,6.71,11.53A1,1,0,1,0,5.29,13l3.84,3.84a1,1,0,0,0,1.42,0l8.16-8.16A1,1,0,0,0,18.71,7.21Z"/></svg> Tailured Originals</li>
