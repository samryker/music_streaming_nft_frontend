				...
				<div class="col-12">
					<div class="sign">
						<div class="sign__content">
							<!-- authorization form -->
							<form action="#" class="sign__form" id="sigin_user" method="post">
							<div class="article__content"><h3 class="title"> Guest / User Login</h3></div><br>
							<a href="index" class="sign__logo">
								...
								<span class="sign__text"><a href="signin_academics">Continue as College/Student</a></span>
							</form>
