...
$("#sigup_user").submit(function(e) {

    e.preventDefault();
	alert("Thank you for your interest, we are in development, try again later");
});


$("#sigin_user").submit(function(e) {

    e.preventDefault();
	alert("Thank you for your interest, we are in development, try again later");
});

$("#sigin_college").submit(function(e) {

    e.preventDefault();
	// alert("Thank you for your interest, we are in development, try again later");
	window.location.href='index_donate';
});

$("#sigup_college").submit(function(e) {
