			...
			<div class="row row--grid">
				...
				<div class="col-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb__item breadcrumb__item--active">Sign in as College/Student</li>
					</ul>
				</div>
				<!-- end breadcrumb -->
				...
				<div class="col-12">
					<div class="sign">
						<div class="sign__content">
							<!-- authorization form -->
							<form action="#" class="sign__form" id="sigin_college" method="post">
                            <div class="article__content"><h3 class="title"> College / Student Singin</h3></div><br>
								...
								<div class="sign__group">
									<input type="text" class="sign__input" placeholder="Email" required>
								</div>
								...
								<input type="submit" class="sign__btn" type="button" value="Sign in">
								...
								<span class="sign__text">Don't have an account? <a href="signup_academics">Sign up!</a></span>

								<span class="sign__text"><a href="forgot">Forgot password?</a></span><br>
								<span class="sign__text"><a href="signin">Continue as Guest/User</a></span>
							</form>
