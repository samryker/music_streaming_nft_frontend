			...
			<div class="row row--grid">
				...
				<div class="col-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb__item breadcrumb__item--active">Sign up as College/Student</li>
					</ul>
				</div>
				<!-- end breadcrumb -->
				...
				<div class="col-12">
					<div class="sign">
						<div class="sign__content">
							<form action="#" class="sign__form"  id="sigup_college" method="post">
                            <div class="article__content"><h3 class="title"> College / Student Signup</h3></div><br>
								...
								<div class="sign__group">
									<input type="text" class="sign__input" placeholder="Name" required>
								</div>
								...
								<input type="submit" class="sign__btn" type="button" value="Sign up"> 
								...
								<span class="sign__text">Already have an account? <a href="signin_academics">Sign in!</a></span>
							</form>
						</div>
					</div>
				</div>
