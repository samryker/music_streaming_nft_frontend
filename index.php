				...
				<div class="col-12">
					<div class="hero owl-carousel" id="hero">
						<div class="hero__slide" data-bg="img/home/slide1.jpg">
							<h1 class="hero__title">Tailured Will Stand By It’s Slogan</h1>
							<p class="hero__text"><i>“Stitching Dreams Together”</i></p>
							<div class="hero__btns">
								<a href="#" class="hero__btn hero__btn--green">Buy now</a>
								<a href="#about" class="hero__btn">Learn more</a>
							</div>
						</div>

						<div class="hero__slide" data-bg="img/home/slide2.jpg">
							<h2 class="hero__title">Connect With Members From Around the World</h2>
							<p class="hero__text">Connect with people from various backgrounds who’ll love what you’re creating. Discover and learn about artists of different genres and discipline, or find inspiration in unexpected places.</p>
							<div class="hero__btns">
								<a href="#about" class="hero__btn hero__btn--green">Learn more</a>
						...
						<div class="hero__slide" data-bg="img/home/slide3.jpg">
							<h2 class="hero__title">Find People With the Same Music Interests as You</h2>
							<p class="hero__text">Music tells you something about people; it gives you common ground and is the soundtrack to the best moments of our lives. So why not bring together people who like the same music, as well as to share experiences you’re currently missing out on?</p>
							<div class="hero__btns">
								<a href="#about" class="hero__btn">Learn more</a>
							</div>
						</div>
					...
					<div class="article article--page">
						...
						<div class="article__content">
							<!-- <div class="article__artist">
								<img src="img/artists/artist0.jpg" alt="">
								<div>
									<h1>Juice WRLD</h1>
									<span>John Doe</span>
							...
							<div class="row">
								...
								<div class="col-md-9">
									<p>Tailured’s vision is to support art, expression, and cultural activity, by building an online music community platform that only focus on all aspects of the music industry, musicians, and music lovers of all cultures and language categories around the world: rap, pop, jazz, alternative rock, house, classical, reggaeton, & etc.</p><br>
								<p>“This Online Music Platform Entity:
									TAILURED, LLC is based in New York City.
									Was created Wednesday, August 15, 2018 and establishment and publication on February 15, 2022.
									 It’s a honorable dedication and in memory of Carole V. Jackson was born in Selma, Alabama on
									 June 16 1936 who was a musician that played and taught every music instrument, vocalist,
									 and wrote music. And Roderick Hicks aka Rod, Hickey, Doo, or Music Man was born July 1, 1941
									 in Detroit, Michigan. He was a great musician and vocalist performed for the Queen of England
									 while touring with Aretha Franklin. He had performed with many elite musicians such as Stevie
									  Wonder BB King, and etc. His most important things that he had ever done with music.
									  Was to participate in an 8 week Jazz Program in Dakar Synagogul, West Africa.
									  </p>

										<p>This program was sponsored by United States of America information Agency.
									  It involved 21 students from 12 different countries. Rod helped take America’s
									  gift of jazz to the world and African students.” – Jalanda Carson, President of Tailured, LLC. </p>
									</div>
							</div>
							...
							<ul class="main__list">
								<li class="single-item">
									...
									<div class="single-item__title">
										...
										<span><a href="artist">AudioPizza</a></span>
									</div>
			...
			<section class="row row--grid">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<a href="podcasts" class="main__link">See all <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17.92,11.62a1,1,0,0,0-.21-.33l-5-5a1,1,0,0,0-1.42,1.42L14.59,11H7a1,1,0,0,0,0,2h7.59l-3.3,3.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0l5-5a1,1,0,0,0,.21-.33A1,1,0,0,0,17.92,11.62Z"/></svg></a>
					</div>
				</div>
				<!-- end title -->
			...
			<section class="row row--grid">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<a href="store" class="main__link">See all <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17.92,11.62a1,1,0,0,0-.21-.33l-5-5a1,1,0,0,0-1.42,1.42L14.59,11H7a1,1,0,0,0,0,2h7.59l-3.3,3.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0l5-5a1,1,0,0,0,.21-.33A1,1,0,0,0,17.92,11.62Z"/></svg></a>
					</div>
				</div>
				<!-- end title -->
			...
			<section class="row row--grid">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<a href="news" class="main__link">See all <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17.92,11.62a1,1,0,0,0-.21-.33l-5-5a1,1,0,0,0-1.42,1.42L14.59,11H7a1,1,0,0,0,0,2h7.59l-3.3,3.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0l5-5a1,1,0,0,0,.21-.33A1,1,0,0,0,17.92,11.62Z"/></svg></a>
					</div>
				</div>
				<!-- end title -->
